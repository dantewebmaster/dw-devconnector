...
const parseExportedGeoStructures = (state, payload) => {
  const parsedExportedGeoStructures = payload.map(item => {
  ...
  return {
    ...state,
    exportGeoStructuresResult: {
      ...state.exportGeoStructuresResult,
      exportedGeoStructures: parsedExportedGeoStructures,
    },
  };
};
...
export default function zones(state = initialState, action) {
  ...
  switch (type) {
    ...
    case types.EXPORT_GEO_STRUCTURES_CANCEL:
      return {
        ...state,
        exportGeoStructuresResult: { ...state.exportGeoStructuresResult, pending: false, cancel: true }
      };
    case types.EXPORT_GEO_STRUCTURES_FINISH:
      return {
        ...state,
        exportGeoStructuresResult: { ...state.exportGeoStructuresResult, pending: false, cancel: false }
      };
