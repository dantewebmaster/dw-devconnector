...
export const exportGeoStructures = (config) => (dispatch) => dispatch({
  type: types.EXPORT_GEO_STRUCTURES,
  payload: ZonesApi.getGeoStructures(config)
});
export const exportGeoStructuresCancel = () => (dispatch) => dispatch({
  type: types.EXPORT_GEO_STRUCTURES_CANCEL,
});
