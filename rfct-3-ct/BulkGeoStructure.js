...
const BulkGeoStructure = ({ handlers, fields }) => {
  ...
  const exporting = fields.exportInProcess && !fields.exportFinished;
  ...
  return <React.Fragment>
    ...
    <div className="pull-right">
      ...
      <RaisedButton
        disabled={fields.exportInProcess}
        onClick={handlers.bulkGeoStructureExport}
        label={exporting ? <FormattedMessage
          id="actions.geo_structures_processing"
          defaultMessage="Procesando, aguarde..."
          description="Rótulo de ação - Procesando, aguarde..."
        /> : <FormattedMessage
