...
class BatchReactivateQueue extends PureComponent {
  state = {
    expanded: true
  };
  ...
  handleConfirmBatchReactivate = (event) => {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {lists.bulkReactivateQueue &&
          lists.bulkReactivateQueue.map((item, index) => {
                ...
                <React.Fragment>
                  ...
                  <ExpansionPanelActions>
                    <Button
                      variant="contained"
                      color="primary"
                      onClick={this.handleConfirmBatchReactivate}
                    >{intl.formatMessage({
                      id: 'common.confirm',
...
BatchReactivateQueue.propTypes = {
...
export default withStyles(styles)(injectIntl(BatchReactivateQueue));
