    ...
    <Link to={linkTo && linkTo} className={classes.cardLink}>
      <Paper className={classes.root} elevation={2}>
        <div className={classes.cardHeader}>
          ...
          <Typography variant="subtitle1" component="h3" className={classes.headerTitle}>{title}</Typography>
        </div>
        <Divider className={classes.divider} />
        <Typography variant="body1" component="p" className={classes.cardDesc}>{desc}</Typography>
      </Paper>
    </Link>
  );
};
