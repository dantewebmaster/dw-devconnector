...
class ProfileGithub extends Component {
	state = {
		clientId: '30a21a13e7e8f99090af',
		clientSecret: 'a61f38e349aa51d3c64d457f8b4d16cf9354cdd5',
		count: 5,
		sort: 'created: asc',
		repos: [],
	}
	...
	componentDidMount() {
		...
		fetch(`https://api.github.com/users/${username}/repos?per_page=${count}&sort=${sort}&client_id=${clientId}&client_secret=${clientSecret}`)
			.then(res => res.json()).then(data => this.setState({ repos: data })).catch(err => console.log(err));
	}
